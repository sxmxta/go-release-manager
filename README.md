...
- **Designer**: ENERGY GUI 设计器, 它会自动更新 energy 的 Go 依赖模块
- **一、克隆 designer**
```cmd
...
- **二、克隆 go-release-manager**
```cmd
git clone https://github.com/sxmxta/go-release-manager.git
```
- **三、运行**
- 使用 designer 打开 go-release-manager 的项目文件 go-release-manager.egp
- 运行 go-release-manager
```cmd
go run main.go 
或
使用 designer 运行
