...
```cmd
git clone https://github.com/your-repo/energy-release.git 
cd energy-release
```
...
```cmd
Windows
go build -o energy-release.exe main.go
macOS / Linux
go build -o energy-release main.go
```
